...
<f:form action="/updatemerchantdone" method="post" modelAttribute="merchantData" onsubmit="fun1()">

		<label  class="col-sm-2 col-form-label"><b>Enter Id </b></label> 
		...
		<label  class="col-sm-2 col-form-label"><b>Update Password </b></label>
