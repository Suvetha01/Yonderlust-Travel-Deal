...
<body>
    ...
    <h2>Welcome ${merchantData.merchantName}</h2><br>
    ...
    <div>
        ...
        <a href="adddeal/${merchantData.merchantId }"><button class="noselect red"><b>REGISTER DEAL</b></button></a>
        <a href="viewdeal/${merchantData.merchantId }"><button class="noselect green" ><b>VIEW DEAL</b></button></a>
    </div>
    
    <br><br>

	<div align="right">
	<a class="btn btn-success" href="updatemerchants/${merchantData.merchantId }">Update Your Profile</a>
	</div><br>
